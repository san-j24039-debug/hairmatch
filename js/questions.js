...
export const steps = [
 {title:'どの商品から探しますか？',description:'探したい商品の種類を選んでください。\nあとから変更することもできます。',fields:[field('category','商品タイプ',[['drugstore','市販系'],['salon','サロン系'],['both','両方']])]},
...
export function isStepComplete(index,a) {return steps[index].fields.every(f=>f.multi?a[f.key]?.length:!!a[f.key]) && (index!==3 || a.finish?.includes(a.priority));}
